  ...
  const calculatePackageDistribution = () => {
    ...
    placedStudents.forEach((student) => {
      const packageValue = parseInt(
        student.package.replace("₹", "").replace(" LPA", "")
      );
      if (packageValue >= 10 && packageValue < 15) ranges["10-15 LPA"] += 4;
      else if (packageValue >= 15 && packageValue < 20)
        ranges["15-20 LPA"] += 5;
      else if (packageValue >= 20 && packageValue < 25)
        ranges["20-25 LPA"] += 3;
