            ...
            <DialogContent className="sm:max-w-[600px]">
              ...
              <div className="grid grid-cols-1 gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input id="branch" className="col-span-2" />
                </div>
                <div className="grid grid-cols-4 items-center gap-4 ">
                  <Label htmlFor="cgpa" className="text-left">
                    CGPA
                  </Label>
                  <Input id="cgpa" className="col-span-2  " />
                </div>
                <div className="grid grid-cols-4 items-center gap-4 ">
                  <Label htmlFor="resume" className="text-left">
                    Resume
                  </Label>
                  <Input id="resume" type="file" className="col-span-2  " />
                </div>
              </div>
              <DialogFooter>
